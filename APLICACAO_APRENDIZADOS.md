...
- **Classes Principais:**
  ...
  - `Arbitro` (Referee): Com atributos de email, nacionalidade, tipo (Principal/Assistente/VAR/Quarto) e pontuação FIFA.
  - `Hotel` (Alojamento): Onde controlamos quartos atribuídos.
