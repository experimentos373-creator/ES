...
* **Falhas:** 0
* **Erros:** 0
* **Tempo de Execução:** ~18.3 segundos
...
### 🔹 Módulo 2 — Gestor de Arbitragem & Regulamentos (Leonardo Mendes)
...
### 🔹 Módulo 1 & 3 — Administrador, Classificações, Bracket, Cartões e Sorteios (Paulo Gomes)
...
#### I. [RegulamentoCartoesTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/RegulamentoCartoesTest.java)
Valida as regras de acumulação de amarelos, suspensões automáticas e limpeza de cartões.
* **`testAcumulacaoAmarelosESuspensao`**
  - **Descrição:** Garante que o acúmulo de 2 amarelos transita o jogador para `SUSPENSO`.
* **`testLimpezaAmarelosNasMeiasFinais`**
  - **Descrição:** Valida a limpeza de cartões amarelos simples na transição para as meias-finais.
* **`testOrdemProcessamentoEventosELimpezaNosQuartos`**
  - **Descrição:** Garante que os cartões nos quartos-de-final são registados antes do reset.
* **`testCumprimentoSuspensaoNosQuartosELimpeza`**
  - **Descrição:** Garante que um jogador suspenso cumpre a suspensão, retorna a `APTO` e tem o cadastro limpo.

#### J. [SorteioPotesTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/SorteioPotesTest.java)
Garante a integridade do algoritmo de sorteio de grupos por potes.
* **`testSorteioPotesEquilibrado`**
  - **Descrição:** Garante a distribuição correta das equipas por ranking entre os grupos.

#### K. [SimulacaoJogoTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/SimulacaoJogoTest.java)
Garante a execução correta da simulação minuto a minuto de jogos.
* **`testSimulacaoJogoValida`**
  - **Descrição:** Verifica que a simulação gera estatísticas, altera o estado do jogo para `FINALIZADO` e produz golos coerentes com o placar final.

---

### 🔹 Módulo 4 & 5 — Bilheteira e Logística (Arthur)

#### L. [AlojamentoCapacidadeTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/AlojamentoCapacidadeTest.java)
Valida as regras de atribuição de hotéis e alojamentos às comitivas.
* **`testAlocacaoHotelCapacidadeExcedida`**
  - **Descrição:** Garante que uma `Equipa` com 26 convocados não pode ser alojada num `Hotel` com capacidade máxima de 25 pessoas (squadSize > capacidadePessoas).
...
#### M. [LotacaoEstadioTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/LotacaoEstadioTest.java)
...
#### N. [AntiBotBilheteiraTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/AntiBotBilheteiraTest.java)
Implementa o controlo de segurança no fluxo de bilheteira (Integridade de Acesso).
...
#### O. [ConcorrenciaManagerTest](file:///e:/Projeto_ES_Paulo_Gomes_2024134892/projeto_java/src/test/ConcorrenciaManagerTest.java)
Valida a robustez e thread-safety em operações concorrentes.
* **`testAlocacaoConcorrenteHotel`**
  - **Descrição:** Dispara threads simultâneas para alocar alojamento, garantindo que o limite de capacidade e exclusividade do Hotel é mantido sob concorrência.
* **`testCompraConcorrenteBilhetes`**
  - **Descrição:** Garante que compras concorrentes no mesmo setor de estádio não excedem a lotação total do setor.
...
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.333 s -- in test.AntiBotBilheteiraTest
[INFO] Running test.SigiloArbitrosTest
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.082 s -- in test.SigiloArbitrosTest
[INFO] Running test.AvancoBracketTest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.363 s -- in test.AvancoBracketTest
[INFO] Running test.LotacaoEstadioTest
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.261 s -- in test.LotacaoEstadioTest
[INFO] Running test.GrupoClassificacaoTest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.796 s -- in test.GrupoClassificacaoTest
[INFO] Running test.IntervaloArbitroTest
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.451 s -- in test.IntervaloArbitroTest
[INFO] Running test.SorteioPotesTest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.926 s -- in test.SorteioPotesTest
[INFO] Running test.ConcorrenciaManagerTest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.680 s -- in test.ConcorrenciaManagerTest
[INFO] Running test.AlojamentoCapacidadeTest
[INFO] Tests run: 8, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1.471 s -- in test.AlojamentoCapacidadeTest
[INFO] Running test.SimulacaoJogoTest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.204 s -- in test.SimulacaoJogoTest
[INFO] Running test.CalendarioJogoTest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.360 s -- in test.CalendarioJogoTest
[INFO] Running test.ScoreFIFATest
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.307 s -- in test.ScoreFIFATest
[INFO] Running test.NeutralidadeArbitroTest
[INFO] Tests run: 4, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1.051 s -- in test.NeutralidadeArbitroTest
[INFO] Running test.RegulamentoCartoesTest
[INFO] Tests run: 4, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.807 s -- in test.RegulamentoCartoesTest
[INFO] Running test.JogadorStateTest
[INFO] Tests run: 4, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.004 s -- in test.JogadorStateTest
[INFO] 
[INFO] Results:
